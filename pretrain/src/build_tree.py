'''
Author: your name
Date: 2021-09-05 16:53:00
LastEditTime: 2021-10-24 15:58:13
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /model/lsc_code/preTrain_in_MIMIC-III/code/build_tree.py
'''
...
def build_px_tree(unique_codes):
    res = []
    graph_voc = Voc()
    root_node = 'px_root'
    for code in unique_codes:
