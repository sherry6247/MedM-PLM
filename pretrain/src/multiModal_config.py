...
class FuseBertConfig(object):
    """Configuration class to store the configuration of a `FuseBertModel`.
    """
    ...
    def __init__(self,
        ...
        Args:
            ...
            code_hidden_size: Size of the encoder layers and the pooler layer in structured data module.
            code_num_hidden_layers: Number of hidden layers in the structured Transformer encoder.
            code_num_attention_heads: Number of attention heads fro each attention layer in the
                structured data Transformer encoder.
            code_intermediate_size: The size of the "intermediate" (i.e., feed-forward) layer in
                the structured data Transformer encoder.
            code_hidden_act: The non-linear activation function(function or string) in the structured
                data encoder and pooler. If string, "gelu", "relu" and "swish" are supported.
            code_hidden_dropout_prob: The dropout probability for all fully connected layer in the
                structured data embeddings, encoder, and pooler.
